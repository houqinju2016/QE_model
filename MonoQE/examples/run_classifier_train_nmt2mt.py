...
from pytorch_pretrained_bert.modeling import BertForSequenceClassification,BertModel, BertConfig, WEIGHTS_NAME, CONFIG_NAME
...
class MyProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        ...
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "train.nmt2mt.tsv")), "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "dev.nmt2mt.tsv")), "dev")
        ...
        for eidx in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
                ...
                try:
                    ...
                    # summary_writer.add_scalar("train_losses", loss, global_step=nb_tr_steps)
