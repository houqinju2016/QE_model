...
from pytorch_pretrained_bert.modeling_1 import BertForSequenceClassification,BertModel, BertConfig, WEIGHTS_NAME, CONFIG_NAME
...
class MyProcessor(DataProcessor):
    ...
    def get_test_examples(self, data_dir):
        ...
        return self._create_examples_test(
            self._read_tsv(os.path.join(data_dir, "train.nmt2mt.tsv")), "test2017")
...
def main():
    ...
    if args.do_eval and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        for  bacth_eval in eval_dataloader:
            ...
            input_ids, input_mask, segment_ids=bacth_eval
        ...
        output_eval_file = os.path.join(args.output_dir, "eval_results_train.txt")
