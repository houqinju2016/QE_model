...
python -m test_rnn \
  ...
  --qe_model_path "/home/houq/pytorch_bert/pytorch-pretrained-BERT-master/qe_exact_feature_en2de2017_dede_transformer_mt2nmt_output/qe_bert.best.21300" \
  --layers=-1 \
  --max_seq_length=50 \
  --test_batch_size 24 \
  --saveto "./result_exact_feature_en2de2017_dede_transformer_mt2nmt_output/QE_en2de2017_train_predict.hter" \