...
python -m examples.run_classifier_train \
  ...
  --output_dir ./qe_en2de2017_transformer_nmt2mt_finetuning_common_multilingual_output_3_bs_32/ \
  --log_path "./log_en2de2017_transformer_nmt2mt_finetuning_common_multilingual_3_bs_32" \